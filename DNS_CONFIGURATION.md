# DNS Configuration for cyangugudims.com

## 🌐 **Your Server Details**

- **Domain**: cyangugudims.com
- **Server IP**: 159.198.36.184
- **VPS**: server1.cyangugudims.com
...
### **4. Setup SSL with Certbot (Recommended)**
```bash
# Install Certbot
...
6. **Setup DNS**: Add A records in Namecheap pointing to 159.198.36.184
